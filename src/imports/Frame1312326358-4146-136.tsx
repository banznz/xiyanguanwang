...
import imgRectangle34629680 from "figma:asset/38fada175042e7f64e6dd64565b2fe2a6170e5d2.png";
import imgImage47 from "figma:asset/27b655a33a93a065da4eb76248cb05709cc8df60.png";
  ...
  return (
    <div className="bg-[#151515] border border-[rgba(255,255,255,0.15)] border-solid overflow-clip relative rounded-[24px] size-full">
      ...
      <div className="absolute h-[177px] left-1/2 rounded-[12px] top-[26px] translate-x-[-50%] w-[316px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[12px] size-full" src={imgRectangle34629680} />
      </div>
      <div className="absolute h-[57px] left-[30px] top-[calc(50%+0.5px)] translate-y-[-50%] w-[458px]" data-name="image 47">
