...
function Container1() {
  return (
    <div className="absolute bg-[rgba(57,117,254,0.1)] content-stretch flex items-center justify-center left-[calc(50%-0.5px)] px-[20px] py-[6px] rounded-[21px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Container">
      <Container />
    </div>
  );
}
