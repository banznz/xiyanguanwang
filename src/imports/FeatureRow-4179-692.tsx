function Container() {
  return (
    <div className="absolute backdrop-blur-[2px] backdrop-filter bg-[rgba(255,255,255,0.05)] content-stretch flex items-center justify-center left-[12px] rounded-[16px] size-[32px] top-[12px]" data-name="Container">
...
function Frame1() {
  return (
    <div className="basis-0 bg-[#121415] grow h-[90px] min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container />
        <p className="-webkit-box absolute font-['PingFang_SC:Regular',sans-serif] h-[60px] leading-[normal] left-[52px] not-italic overflow-ellipsis overflow-hidden text-[14px] text-white top-[18px] w-[136px]">我在阁楼的樟木箱底翻到那张照片时，指尖先触到了一层薄薄的霉斑。</p>
      </div>
...
function Frame2() {
  return (
    <div className="basis-0 bg-[#121415] grow h-[90px] min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container1 />
        <p className="-webkit-box absolute font-['PingFang_SC:Regular',sans-serif] h-[60px] leading-[normal] left-[52px] not-italic overflow-ellipsis overflow-hidden text-[14px] text-white top-[18px] w-[136px]">昏黄的日光从老虎窗斜射进来，刚好落在照片边缘卷起的折痕上。</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Frame3() {
  return (
    <div className="basis-0 bg-[#121415] grow h-[90px] min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container2 />
        <p className="-webkit-box absolute font-['PingFang_SC:Regular',sans-serif] h-[60px] leading-[normal] left-[52px] not-italic overflow-ellipsis overflow-hidden text-[14px] text-white top-[18px] w-[136px]">照片上是十七岁的我和阿柚，站在学校后门的老槐树下，</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-start left-[32px] top-[147px] w-[632px]">
      <Frame1 />
      <Frame2 />
      <Frame3 />
    </div>
...
function Frame5() {
  return (
    <div className="basis-0 bg-[#121415] grow h-full min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container3 />
        <p className="-webkit-box absolute font-['PingFang_SC:Regular',sans-serif] h-[87px] leading-[24px] left-[52px] not-italic overflow-ellipsis overflow-hidden text-[14px] text-[rgba(255,255,255,0.7)] top-[18px] w-[136px]">我在阁楼的樟木箱底翻到那张照片时，指尖先触到了一层薄薄的霉斑。</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Frame6() {
  return (
    <div className="basis-0 bg-[#121415] grow h-full min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container4 />
        <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[24px] left-[52px] not-italic text-[14px] text-[rgba(255,255,255,0.7)] top-[18px] w-[136px]">昏黄的日光从老虎窗斜射进来，刚好落在照片边缘卷起的折痕上。</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Frame7() {
  return (
    <div className="basis-0 bg-[#121415] grow h-full min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container5 />
        <p className="absolute font-['PingFang_SC:Regular',sans-serif] h-[60px] leading-[24px] left-[52px] not-italic text-[14px] text-[rgba(255,255,255,0.7)] top-[18px] w-[136px]">照片上是十七岁的我和阿柚，站在学校后门的老槐树下，</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Container6() {
  return (
    <div className="absolute backdrop-blur-[2px] backdrop-filter bg-[rgba(255,255,255,0.05)] content-stretch flex items-center justify-center left-[12px] rounded-[16px] size-[32px] top-[12px]" data-name="Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] not-italic relative shrink-0 text-[18px] text-nowrap text-white whitespace-pre">4</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute backdrop-blur-[2px] backdrop-filter bg-[rgba(255,255,255,0.05)] content-stretch flex items-center justify-center left-[12px] rounded-[16px] size-[32px] top-[12px]" data-name="Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] not-italic relative shrink-0 text-[18px] text-nowrap text-white whitespace-pre">5</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[12px] top-[12px]">
      <Container7 />
      <p className="absolute font-['PingFang_SC:Regular',sans-serif] h-[60px] leading-[24px] left-[52px] not-italic text-[14px] text-[rgba(255,255,255,0.7)] top-[18px] w-[136px]">她扎着高马尾，额前碎发被风掀起，嘴角弯成月牙</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="basis-0 bg-[#121415] grow h-full min-h-px min-w-px relative rounded-[16px] shrink-0">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[normal] left-[calc(50%-14px)] not-italic overflow-ellipsis overflow-hidden text-[14px] text-nowrap text-white top-[calc(50%-10.25px)] whitespace-pre">····</p>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.05)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[305px] items-start left-[32px] top-[147px] w-[632px]">
      <Frame8 />
      <Frame12 />
    </div>
  );
